...
export const isConfirmedByCodeValidation = body('code').isString().trim().custom(async (code) => {
...
export const emailConfirmationByCodeMiddleWare = () => [isConfirmedByCodeValidation, inputValidation]